...
/**
 * File name: SongMasterDTO Package name: com.cg.mp.dto Description:This is a
 * POJO class which provides getters and setters for Song Version: 1.0
 * Restrictions:N/A
 * 
...
public class SongMasterDTO implements Comparator<SongMasterDTO> {
	@Id
	...
	public void disp() {
		...
		System.out.printf("%-30s%-30s%-30s%-30s%-30s%-30s%-30s\n", "Song ID",
				"Song Name", "Song Duration", "Created By", "Created On",
	...
	public String toString() {
		...
		return String.format("%-30s%-30s%-30s%-30s%-30s%-30s%-30s", songId,
				songName, songDuration, createdBy, createdOn, updatedBy,
				updatedOn);
