...
/**
 * File name: ArtistMasterDTO Package name: com.cg.mp.dto Description:This is a
 * POJO class which provides getters and setters for Artist Version: 1.0
 * Restrictions:N/A
 * 
...
public class ArtistMasterDTO {
	...
	public void disp() {
		...
		System.out.printf(
				...
				"Artist Id", "Artist Name", "Artist Type", "Born Date",
				"Died Date", "createdBy", "Created On", "UpdatedBy",
				"Updated On", "Del Flag");
		System.out
				.println("-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
	}
	...
	public String toString() {
		return String.format(
				"%-30s%-30s%-30s%-30s%-30s%-30s%-30s%-30s%-30s%-30s", artistId,
				artistName, artistType, artistBornDate, artistDiedDate,
				createdBy, createdOn, updatedBy, updatedOn, artistDelFlag);
	}
