...
<body>
	...
	<div class="side-nav">
		...
		<div class="side-nav1">
			...
			<form:form name="form" action="addArtist.obj"
				...
				<form:input type="date" path="artistBornDate" max="${sqlDate}"
					required="true" />
				<br />
				...
				<div class="row" id="row_dim">
					...
					<form:input type="date" id="artistDiedDate" path="artistDiedDate" value="" max="${sqlDate}" />
					<br />
				</div>
